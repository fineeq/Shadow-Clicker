...
[⬇️ Download Shadow Clicker](https://github.com/fineeq/Shadow-Clicker/releases/latest/download/Shadow-Clicker.exe)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/fineeq/Shadow-Clicker.git
   cd Shadow-Clicker
